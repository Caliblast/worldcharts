...
<div data-role="page" id="page" style="background-image: url('backgrounds/france.jpg'); background-attachment: fixed; background-repeat: no-repeat; background-size: 100% 100%;"
    data-theme="a">
	...
	<?php
        ...
        while ($row = mysql_fetch_assoc($result)) {
			echo "<div data-role='collapsible' data-theme='c' data-content-theme='c'>";
				...
				echo "<td width = '80%'><iframe width='560' height='315' src='".$row["Youtube"]."' frameborder='0' allowfullscreen></iframe></td>";
				echo "<td width = '20%'>";
				echo "<a href='".$row["Itunes"]."' target = 'blank' data-role='button' data-theme='b' >Get it on Itunes</a>";
				echo "<a href='".$row["Amazon"]."' target = 'blank'  >Get it on Amazon</a>";
